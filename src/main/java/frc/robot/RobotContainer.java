...
public class RobotContainer implements Sendable {
  ...
  private void configureDriver() {
    ...
    driverController
        .povUp()
        .onTrue(
            new InstantCommand(()->prepState = PrepState.CLIMB).andThen(
            new ClimbPrepSequence(intake, elevator, shooter, conveyor, intakeLimelight))
                ...
                .andThen( () ->
                    new SequentialCommandGroup(
                        ...
                        .raceWith(new WaitUntilCommand(driverJoysticksActive)).schedule())
    ...
    public void initSendable(SendableBuilder builder){
        builder.addStringProperty("prepState", ()->{return prepState.toString();}, null);
    }
}
