...
public class TwoWithCenterNote extends SequentialCommandGroup {
  ...
  public TwoWithCenterNote(DriveSubsystem drive, Intake intake, Elevator elevator, Shooter shooter, Conveyor conveyor, ShooterLimelight limelight) {
    NamedCommands.registerCommand("goHomeWithShooterSpunUp", new GoHomeSequence(intake, elevator, shooter, conveyor, true));
    NamedCommands.registerCommand("intakeNote", new IntakeSequence(intake, elevator, conveyor, shooter).withTimeout(5.0));
