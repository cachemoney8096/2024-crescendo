...
public class ClimbPrepSequence extends SequentialCommandGroup {
  public ClimbPrepSequence(Intake intake, Elevator elevator, Shooter shooter, Conveyor conveyor, IntakeLimelight intakeLimelight) {
    final SequentialCommandGroup restOfPrep =
        new SequentialCommandGroup(
        new InstantCommand(() -> intakeLimelight.setLimelightValues(limelightLedMode.OFF, limelightCamMode.VISION_PROCESSING, limelightPipeline.TAG_PIPELINE)),
