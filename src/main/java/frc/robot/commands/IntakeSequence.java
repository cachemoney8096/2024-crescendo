  ...
  public IntakeSequence(Intake intake, Elevator elevator, Conveyor conveyor) {
    ...
    addCommands(
      new ConditionalCommand(new InstantCommand(),new SequentialCommandGroup(
                ...
                new WaitUntilCommand(elevator::elevatorBelowInterferenceThreshold)), elevator::atDesiredPosition),

      new InstantCommand( 
      () -> {
        intake.setDesiredIntakePosition(IntakePosition.DEPLOYED);}, intake),
