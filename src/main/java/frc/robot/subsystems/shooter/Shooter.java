...
public class Shooter extends SubsystemBase {
  ...
  public boolean initSparks() {
    ...
    errors += SparkMaxUtils.check(motorRight.setPeriodicFramePeriod(PeriodicFrame.kStatus0, 20));
    errors += SparkMaxUtils.check(motorRight.setPeriodicFramePeriod(PeriodicFrame.kStatus1, 20));
    errors += SparkMaxUtils.check(motorRight.setPeriodicFramePeriod(PeriodicFrame.kStatus2, 50));
    errors += SparkMaxUtils.check(motorRight.setPeriodicFramePeriod(PeriodicFrame.kStatus3, 500));
    errors += SparkMaxUtils.check(motorRight.setPeriodicFramePeriod(PeriodicFrame.kStatus4, 500));
    errors += SparkMaxUtils.check(motorRight.setPeriodicFramePeriod(PeriodicFrame.kStatus5, 200));
    errors += SparkMaxUtils.check(motorRight.setPeriodicFramePeriod(PeriodicFrame.kStatus6, 200));
    errors += SparkMaxUtils.check(motorLeftOne.setPeriodicFramePeriod(PeriodicFrame.kStatus0, 20));
    errors += SparkMaxUtils.check(motorLeftOne.setPeriodicFramePeriod(PeriodicFrame.kStatus1, 20));
    errors += SparkMaxUtils.check(motorLeftOne.setPeriodicFramePeriod(PeriodicFrame.kStatus2, 50));
    errors += SparkMaxUtils.check(motorLeftOne.setPeriodicFramePeriod(PeriodicFrame.kStatus3, 500));
    errors += SparkMaxUtils.check(motorLeftOne.setPeriodicFramePeriod(PeriodicFrame.kStatus4, 500));
    errors += SparkMaxUtils.check(motorLeftOne.setPeriodicFramePeriod(PeriodicFrame.kStatus5, 200));
    errors += SparkMaxUtils.check(motorLeftOne.setPeriodicFramePeriod(PeriodicFrame.kStatus6, 200));
    errors += SparkMaxUtils.check(motorLeftTwo.setPeriodicFramePeriod(PeriodicFrame.kStatus0, 20));
    errors += SparkMaxUtils.check(motorLeftTwo.setPeriodicFramePeriod(PeriodicFrame.kStatus1, 20));
    errors += SparkMaxUtils.check(motorLeftTwo.setPeriodicFramePeriod(PeriodicFrame.kStatus2, 50));
    errors += SparkMaxUtils.check(motorLeftTwo.setPeriodicFramePeriod(PeriodicFrame.kStatus3, 500));
    errors += SparkMaxUtils.check(motorLeftTwo.setPeriodicFramePeriod(PeriodicFrame.kStatus4, 500));
    errors += SparkMaxUtils.check(motorLeftTwo.setPeriodicFramePeriod(PeriodicFrame.kStatus5, 200));
    errors += SparkMaxUtils.check(motorLeftTwo.setPeriodicFramePeriod(PeriodicFrame.kStatus6, 200));
  ...
  /**
   * Sends pivot to the latch position but doesn't use arbitrary latch holding voltage (applies
   * controlPosition()). Should be called every cycle when this is desired.
   */
  ...
  public void periodic() {
    if (allowShooterMovement) {
      switch (shooterMode) {
        ...
        case LATCH:
          stopShooter();
          if (getPivotPositionDegrees() - ShooterCal.LATCH_ANGLE_DEGREES
              > ShooterCal.LATCH_SAFE_MARGIN_DEGREES) {
