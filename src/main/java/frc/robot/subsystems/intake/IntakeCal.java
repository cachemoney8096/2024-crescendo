...
public class IntakeCal {
   ...
   * that position.
   */
  public static final double INTAKE_ABSOLUTE_ENCODER_ZERO_OFFSET_DEG = 180 - 89.1;
   ...
   */
  public static final double INTAKE_ABSOLUTE_ENCODER_WRAP_POINT_DEG = 63.0;
  ...
  public static final double CONVEYOR_ZONE_THRESHOLD_DEGREES = 265.0;
