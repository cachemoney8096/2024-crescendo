...
public class TalonDriveSubsystem extends SubsystemBase {
  ...
  public final TalonSwerveModule frontLeft =
  ...
  public TalonDriveSubsystem(MatchStateUtil matchState) {
    intializeGyro();
